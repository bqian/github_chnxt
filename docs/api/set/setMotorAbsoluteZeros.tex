...
\rule{4.5in}{0.015in}\\
\noindent
{\LARGE \texttt{ChNXT::setMotorAbsoluteZeros()} \index{ChNXT::setMotorAbsoluteZeros()}}\\

\addcontentsline{toc}{subsection}{setMotorAbsoluteZeros()}
...
None.\\
\\
%%%%% END OF ChNXT::setMotorAbsoluteZeros %%%%%
